...
class Network:
    ...
    def define_model(self, points):
        ...
        x = tf.keras.layers.Conv1D(16, 3, activation='relu', padding='same', name='Conv1D-1')(encoder_input)
        ...
        decoder_input = tf.keras.layers.Input(shape=(encoded.shape[1], encoded.shape[2], ), batch_size=None, name='DecoderInput')
