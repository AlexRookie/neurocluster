...
class Network:
    ...
    def define_model(self, units=(1,10), classes=0):
        ...
        x = tf.keras.layers.Conv1D(filters=6, kernel_size=3, padding='valid', name='Conv1D-1')(x)
        ...
        encoded = tf.keras.layers.Dense(units=16, use_bias=False, name='Dense-1')(x)
        ...
        x = tf.keras.layers.Dense(units=60, use_bias=False, name='Dense-2')(decoder_input)
        x = tf.keras.layers.Reshape((6,10), name='Reshape')(x)
        ...
        x = tf.keras.layers.Conv1DTranspose(filters=4, kernel_size=3, padding='valid', name='Deconv1D-3')(x)
        ...
        x = tf.keras.layers.Dense(units=12, activation='relu', use_bias=False, name='Dense-3')(encoded)
